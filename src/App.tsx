...
export default function App() {
  ...
  const screens = [
    ...
    {
      emoji: "🤔",
      title: "Aur koi hai kya yahan?",
      subtitle: "Waise mujhe tujhse ek serious baat karni thi...",
      buttonText: "Kya baat hai? 😨",
      action: () => setStep(2),
    },
    {
      emoji: "🔐",
      title: "Par baat karne layak hai ki nahi...",
      subtitle: "Pehle tera dimag ka level check karte hain. Prove kar ki tu 100% certified Bhondu hai.",
      buttonText: "", // Slider Mini-game
      action: () => {},
    },
    {
      emoji: "😂",
      title: "Haan, theek hai. Mujhe pata hi tha.",
      subtitle: "100% certified Bhondu report verified.",
      buttonText: "Chup kar 😡",
      action: () => setStep(4),
    },
    {
      emoji: "🏆",
      title: "Isiliye...",
      subtitle: "Aaj se tu officially meri favourite Bhondu hai ✨",
      buttonText: "Acha... toh? 🙄",
      action: () => setStep(5),
    },
    {
